...
**The 10× goal is unmet, and the phases as shipped REGRESSED vs phase0.** Root cause is documented in `docs/research/archive/2026-05-18-interpreter-perf-research.md` (archived; the authoritative current-state map is now `docs/research/2026-06-11-perf-benchmark-bottlenecks-and-optimization-ledger.md`; this section is the design-level summary).
